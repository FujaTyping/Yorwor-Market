      ...
      <div className="max-w-6xl mx-auto px-10 py-10">
        <div className="text-center px-6">
          ...
          <p className="text-sm mt-3">
            ...
            สามารถติดต่อเราได้ผ่านช่องทางต่อไปนี้
          </p>
        </div>
        ...
        >
          <div className="bg-blue-500 rounded-lg p-6 h-full max-lg:order-1 text-white hidden md:block">
            ...
            <p className="text-sm mt-4 AnakotmaiBOLD">
              หากคุณมีคำถาม ข้อเสนอแนะ หรือต้องการความช่วยเหลือ
              สามารถติดต่อเราได้ผ่านช่องทางต่อไปนี้
            </p>
            ...
            <ul className="mt-16 space-y-4">
              <li className="flex items-center">
                ...
                <p className="text-sm ml-4">yorwor@siraphop.me</p>
              </li>
              <li className="flex items-center">
            ...
            <div>
              <div className="grid sm:grid-cols-2 gap-8">
                ...
                <div className="relative flex items-center sm:col-span-2">
                  ...
                  >
                    <SelectItem key="ดีมาก">ดีมาก</SelectItem>
                    <SelectItem key="ดี">ดี</SelectItem>
                    <SelectItem key="พอได้">พอได้</SelectItem>
                    <SelectItem key="ใช้ไม่ได้เลย">ใช้ไม่ได้เลย</SelectItem>
                    <SelectItem key="แย่มาก">แย่มาก</SelectItem>
                  </Select>
                </div>
        ...
        >
          <h2 className="text-3xl">
            ...
            <span className="block pt-4 text-sm mt-2 max-w-lg">
              แบบสอบถามนี้จัดทำขึ้นเพื่อเก็บความคิดเห็นของคุณเกี่ยวกับการใช้งาน
              Yorwor Market
              ช่วยให้เราสามารถปรับปรุงและพัฒนาบริการให้เหมาะสมกับความต้องการของผู้ใช้งานมากยิ่งขึ้น
