        ...
        <section className="w-full flex py-5">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex gap-3 flex-col sm:flex-row items-center justify-center mt-6">
              <Button as={Link} href="/goods" color="primary" size="lg">ดูสินค้าทั้งหมด</Button>
              <Button as={Link} href="/about" color="primary" size="lg" variant="bordered">เกี่ยวกับโครงงาน</Button>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto mb-5 mt-2">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-4 max-md:max-w-lg mx-auto mt-5">
              <div className="rounded-xl group p-8 text-center hover:bg-blue-500 hover:text-white hover:shadow-xl transition duration-300">
                ...
                <p className="text-sm">ระบบยืนยันตัวตนเฉพาะสำหรับบุคลากรและนักเรียนในโรงเรียนหาดใหญ่วิทยาลัย เพื่อความปลอดภัยและป้องกันการเข้าถึงจากบุคคลภายนอก</p>
              </div>

              <div className="rounded-xl group p-8 text-center hover:bg-blue-500 hover:text-white hover:shadow-xl transition duration-300">
                <AiOutlineProduct className="w-10 h-10 mb-6 inline-block" />
                <h3 className="text-xl AnakotmaiBOLD mb-3">การจัดการสินค้าส่วนตัว</h3>
                <p className="text-sm">ผู้ใช้งานสามารถเพิ่ม แก้ไข และจัดการสินค้าในร้านค้าของตัวเองได้อย่างสะดวก พร้อมแสดงรูปภาพและรายละเอียดที่ครบถ้วน</p>
              </div>

              <div className="rounded-xl group p-8 text-center hover:bg-blue-500 hover:text-white hover:shadow-xl transition duration-300">
                <TbMessageReport className="w-10 h-10 mb-6 inline-block" />
                <h3 className="text-xl AnakotmaiBOLD mb-3">รายงานปัญหา</h3>
                <p className="text-sm">ระบบแจ้งปัญหาหรือรายงานพฤติกรรมที่ไม่เหมาะสม เช่น สินค้าที่ไม่ตรงตามเงื่อนไข เพื่อให้ทีมงาน Yorwor Market สามารถตรวจสอบและดำเนินการได้อย่างรวดเร็ว</p>
              </div>
            </div>
          </div>
        </div>
